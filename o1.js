...
const testBigInt = (label, value) => {
  try {
    console.log(`Testing ${label}:`, BigInt(value));
  } catch (e) {
    console.log(`${label} conversion failed:`, e.message);
  }
}

testBigInt('public key', publicKey);
testBigInt('payload', payload);
testBigInt('signature', signature);
